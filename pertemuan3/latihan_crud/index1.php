...
<body>
    ...
    <a href="add1.php">Add New Customers</a><br /><br />
    <table width='80%' border=1>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href='edit1.php?id=<?=$customer_data["id"]?>'>Edit</a> | <a
                        href='delete1.php?id=<?=$customer_data["id"]?>'>Delete</a>
                </td>
            </tr>
            <?php endwhile; ?>
            <?php else : ?>
    ...
    echo "window.location='index1.php'</script>";
                }
                ?>
